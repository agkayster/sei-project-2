...
class Home extends React.Component {
  ...
  newsUpdate() {
    ...
    axios
      .get(
        `https://newsapi.org/v2/top-headlines?country=gb&apiKey=${process.env.NEWSAPI_KEY}`
      )
  ...
  render() {
    if (!this.state.newsapi) return <h1>Loading...</h1>
      ...
      <section className="hero is-primary is-medium">
        ...
        <section className="section">
          <div className="container">
            ...
            >
              <h1 id="ejikeStyle" className="title is-2">
                {latestNews.title}
              </h1>
              ...
              <div className="columns">
                ...
                <div className="column">
                  <h2 id="ejikeStyle" className="title is-4">
                    {latestNews.content}
                  </h2>
                </div>
              </div>
